/**********************************************************************
 * Basado en las Notas de Administración Actuarial del Riesgo;
 * Del profesor Jose Enrique Perez ;
 * Facultad de Ciencias. Universidad Nacional Autónoma de México ;
 * Modificado para la tarea 3
 * Álvarado Perez, Cuéllar Chávez, García Tapia.
 **********************************************************************/
